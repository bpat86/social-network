...
import ObjectMapper from '../../utils/helpers';
    ...
    render() {
        ...
        return (
			<div className="edit-profile">
				...
				<h1 className="my-4">Edit your profile</h1>
				<form onSubmit={this.onSubmit}>
					...
					{socialInputs}
					<input type="submit" value={`${this.state.updated ? 'Update' : 'Submit'}`} className="bg-indigo-dark text-grey-lightest bg-transparent rounded font-medium text-center leading-tight h-12 m-0 px-4 py-2 cursor-pointer focus:outline-none"/>
				</form>
			</div>
        );
    }
